...
<section><h2>3. Data Storage and Security</h2><p>Your data is stored on secure servers (Neon PostgreSQL, Vercel). We use industry-standard encryption. No method of electronic storage is 100% secure. We retain data only as long as needed to provide the service, meet legal obligations, resolve disputes, and enforce agreements.</p></section>
<section><h2>4. Third-Party Services</h2><p>We use Stripe (payments), OpenAI (AI processing), Resend (email), and Vercel (hosting). See their privacy policies for details. OpenAI does not use API inputs to train its models. Your proposal content is not retained by OpenAI beyond the processing of your request.</p></section>
<section><h2>5. Cookies</h2><p>We use essential cookies for login sessions. No advertising or tracking cookies.</p></section>
<section><h2>6. Your Rights</h2><p>You may request access, correction, or deletion of your data. Contact <a href="mailto:privacy@contrax.company">privacy@contrax.company</a>. We will respond within 30 days.</p><p>California residents may exercise rights under the CCPA by contacting privacy@contrax.company. We do not sell personal information.</p><p>For individuals in the EU/EEA, our lawful bases for processing are the performance of our contract with you, your consent where required, and legitimate interests. You may exercise GDPR rights (access, correction, erasure, portability, objection) by contacting us.</p></section>
