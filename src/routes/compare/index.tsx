...
const rows = [
  ["Pricing", "$49–399/mo with free trial", "~$29K/yr (enterprise)", "$100–500/mo", "Varies by plan", "$0 (but cost of time)", "$3–10K+/mo retainer"],
...
function ComparePage() {
  return <div className="min-h-screen bg-white">
    ...
    <section className="py-16 sm:py-24"><div className="mx-auto max-w-3xl px-6"><h2 className="text-center text-3xl font-bold text-slate-900">Frequently asked questions</h2><div className="mt-8 divide-y divide-gray-200 rounded-2xl border border-gray-200 bg-white">{[
      ["Is Contrax better than GovWin?", "For small and mid-size businesses, often yes: Contrax is more affordable, easier to onboard, covers more source types, and includes AI proposal tools. GovWin may be a better fit for large enterprises needing deep federal intelligence."],
