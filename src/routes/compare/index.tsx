...
const rows = [
  ...
  ["Bid coverage", "Federal + State + Local (8 sources, automated scans 24/7)", "Federal only (strong)", "State/Local focused", "Federal spend data", "Limited to what you search", "Depends on their expertise"],
...
function ComparePage() {
  return <div className="min-h-screen bg-white">
    ...
    <section className="py-16 sm:py-24"><div className="mx-auto max-w-3xl px-6"><h2 className="text-center text-3xl font-bold text-slate-900">Frequently asked questions</h2><div className="mt-8 divide-y divide-gray-200 rounded-2xl border border-gray-200 bg-white">{[
      ["Is Contrax better than GovWin?", "For small and mid-size businesses, often yes: Contrax is more affordable, easier to onboard, covers more source types, and includes proposal drafting tools. GovWin may be a better fit for large enterprises needing deep federal intelligence."],
      ...
      ["Can I switch from BidNet to Contrax?", "Yes. Contrax can work alongside or replace BidNet for teams that want federal, state, and local coverage plus automated summaries, scoring, and proposal drafting."],
      ...
      ["Do I need any government contracting experience?", "No. Contrax's four-step onboarding, plain-English bid summaries, and guided intelligent tools are designed to help first-time government contractors get started with confidence."],
