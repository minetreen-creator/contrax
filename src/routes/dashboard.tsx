  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <main className="mx-auto max-w-5xl px-4 py-8">
        ...
        <a href="/evaluate" className="mb-4 block rounded-2xl border border-blue-100 bg-gradient-to-r from-blue-50 to-white p-5 shadow-sm transition hover:border-blue-300"><div className="flex items-center justify-between gap-4"><div><h2 className="font-bold text-slate-900">📋 Proposal Evaluator</h2><p className="mt-1 text-sm text-slate-600">Score your draft against the RFP’s Section M criteria</p></div><span className="shrink-0 text-sm font-semibold text-blue-700">Evaluate →</span></div></a>
